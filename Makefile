...
#ccflags-y += -Wno-tautological-pointer-compare -Wno-sometimes-uninitialized
...
ccflags-y += -DCONFIG_WAKE_ON_BT
endif

ifeq ($(CONFIG_RTW_NBI), y)
ccflags-y += -DCONFIG_RTW_NBI
endif

ifeq ($(CONFIG_SECURITY_MEM), y)
ccflags-y += -DCONFIG_SECURITY_MEM
ccflags-y += -DSECURITY_MEM_ADDR=$(CONFIG_SECURITY_MEM_ADDR)
ccflags-y += -DSECURITY_MEM_SIZE=$(CONFIG_SECURITY_MEM_SIZE)
endif
...
ccflags-y += -Wno-unused-function -Wno-implicit-fallthrough
